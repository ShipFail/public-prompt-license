...
*   **The PPL Solution:** PPL explicitly defines **"Prompt Source"** (see `DEFINITIONS.md`) to remove this ambiguity. It asserts that the *cognitive logic* is the source, regardless of the file format.
